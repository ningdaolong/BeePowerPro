...
public class HongWaiActivit extends Activity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    private final static int SCANNIN_GREQUEST_H= 1;
    private final static int SCANNIN_GREQUEST_C = 2;
    private Spinner spinnerA, spinnerB, spinnerC, spinnerD, spinnerE, spinnerF, spinner_Name;
    EditText et_H_MAC,et_C_MAC, et_NAME, et_BZ;
    Button h_scan,c_scan, tijiao;
    ImageView back;
    TextView dingwei;
    ...
    private void initView() {
        spinnerA = (Spinner) findViewById(R.id.hongwai_spinner1);
        spinnerB = (Spinner) findViewById(R.id.hongwai_spinner2);
        spinnerC = (Spinner) findViewById(R.id.hongwai_spinner3);
        spinnerD = (Spinner) findViewById(R.id.hongwai_spinner4);
        spinnerE = (Spinner) findViewById(R.id.hongwai_spinner5);
        spinnerF = (Spinner) findViewById(R.id.hongwai_spinner6);
        spinner_Name = (Spinner) findViewById(R.id.hongwai_spinner_Name);
        ...
        dingwei = (TextView) findViewById(R.id.hongwai_tv_dingwei);

        et_H_MAC = (EditText) findViewById(R.id.hongwai_et_hongwaiMAC);
        et_C_MAC = (EditText) findViewById(R.id.hongwai_et_chazuoMAC);

        back = (ImageView) findViewById(R.id.hongwai_img_back);
        h_scan = (Button) findViewById(R.id.hongwai_btn_hongwai);
        c_scan = (Button) findViewById(R.id.hongwai_btn_chazuo);
        tijiao = (Button) findViewById(R.id.hongwai_btn_tijiao);

        back.setOnClickListener(this);
        h_scan.setOnClickListener(this);
        c_scan.setOnClickListener(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hongwai);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.hongwai_img_back:
                finish();
                break;
            case R.id.hongwai_btn_hongwai:
                Intent intent = new Intent();
                intent.setClass(HongWaiActivit.this, MipcaActivityCapture.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivityForResult(intent, SCANNIN_GREQUEST_H);
                break;
            case R.id.hongwai_btn_chazuo:
                Intent in = new Intent();
                in.setClass(HongWaiActivit.this, MipcaActivityCapture.class);
                in.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivityForResult(in, SCANNIN_GREQUEST_C);
                break;
            case R.id.hongwai_btn_tijiao:
                if (et_H_MAC.getText().toString().equals("")&&et_C_MAC.getText().toString().equals("")){
                    Toast.makeText(HongWaiActivit.this, "不能为空!", Toast.LENGTH_SHORT).show();
                }else {
//                    map.put("city", city_ID);
//                    map.put("floor", floor_ID);
...
//                    map.put("latitude", la);
                    ...
                    bundle.putString("city", city_ID);
                    bundle.putString("floor", floor_ID);
                    bundle.putString("floor_name", floor_name);
                    bundle.putString("room", room_ID);
                    bundle.putString("room_name", room_name);
                    bundle.putString("hh", custID);
                    bundle.putString("hh_name", custName);
                    bundle.putString("longitude", lo);
                    bundle.putString("latitude", la);
                    bundle.putString("hMac", et_H_MAC.getText().toString());
                    bundle.putString("cMac", et_C_MAC.getText().toString());
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int i, long id) {
        switch (parent.getId()) {
            case R.id.hongwai_spinner1:
                volleyTest_b(i);
                break;
            case R.id.hongwai_spinner2:
                volleyTest_c(i);
                break;
            case R.id.hongwai_spinner3:
                volleyTest_d(i);
                break;
            case R.id.hongwai_spinner4:
                volleyTest_e(i);
                break;
            case R.id.hongwai_spinner5:
                volleyTest_f(i);
                break;
            case R.id.hongwai_spinner6:
                //地图定位
                onCreate();
                initLocation();
                mLocationClient.start();

                room_name = room_orgList.get(i).getOrgName();
                room_ID = room_orgList.get(i).getOrgID();
                progressDialog.dismiss();
                break;
            case R.id.hongwai_spinner_Name:
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case SCANNIN_GREQUEST_H:
                if (resultCode == RESULT_OK) {
                    Bundle bundle = data.getExtras();
                    //显示扫描到的内容
                    String str = Utils.replaceBlank(bundle.getString("result"));
                    et_H_MAC.setText(str);
                }
                break;
            case SCANNIN_GREQUEST_C:
                if (resultCode == RESULT_OK) {
                    Bundle bundle = data.getExtras();
                    //显示扫描到的内容
                    String str = Utils.replaceBlank(bundle.getString("result"));
                    et_C_MAC.setText(str);
                }
                break;
        }
    }
    ...
    protected void dialog(final String str, final Boolean flag) {
        AlertDialog.Builder builder = new AlertDialog.Builder(HongWaiActivit.this);
...
//                    volleyTest_CH();
    ...
    private void volleyTest_a() {
        request_a = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(HongWaiActivit.this, android.R.layout.simple_spinner_item, province_arr);
                //设置样式
    ...
    private void volleyTest_b(int i) {
        ...
        if (province_ID.equals("1000011")) {
            ...
            //添加内容
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(HongWaiActivit.this, android.R.layout.simple_spinner_item, city_arr);
            //设置样式
            arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            //添加适配器
    ...
    private void volleyTest_c(int i) {
        ...
        request_c = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter_Name = new ArrayAdapter<String>(HongWaiActivit.this, android.R.layout.simple_spinner_item, name_arr);
                //设置样式
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(HongWaiActivit.this, android.R.layout.simple_spinner_item, county_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
    ...
    private void volleyTest_d(int i) {
        ...
        request_d = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(HongWaiActivit.this, android.R.layout.simple_spinner_item, company_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
    ...
    private void volleyTest_e(int i) {
        ...
        request_e = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(HongWaiActivit.this, android.R.layout.simple_spinner_item, floor_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
    ...
    private void volleyTest_f(int i) {
        progressDialog.show();
        floor_name = floor_orgList.get(i).getOrgName();
        ...
        request_f = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(HongWaiActivit.this, android.R.layout.simple_spinner_item, room_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
