...
public class SheBeiActivity extends Activity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    private final static int SCANNIN_GREQUEST_CODE = 1;
    private Spinner spinner1, spinner2, spinner3, spinner4, spinner5, spinner6, spinner_Name;
    EditText et_MAC, et_NAME;
    Button scan, tijiao, chaihui;
    ImageView back;
    TextView dingwei;
    ...
    private String mac_test = "";

    //初始化
    private void init() {
        dingwei = (TextView) findViewById(R.id.shebei_tv_dingwei);
        ...
        back = (ImageView) findViewById(R.id.shebei_img_back);
        scan = (Button) findViewById(R.id.shebei_btn_scan);
        tijiao = (Button) findViewById(R.id.shebei_btn_tijiao);
        chaihui = (Button) findViewById(R.id.shebei_btn_chaihui);

        back.setOnClickListener(this);
        scan.setOnClickListener(this);
        tijiao.setOnClickListener(this);
        chaihui.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.shebei_img_back:
                finish();
                break;
            case R.id.shebei_btn_scan:
                Intent intent = new Intent();
                intent.setClass(SheBeiActivity.this, MipcaActivityCapture.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivityForResult(intent, SCANNIN_GREQUEST_CODE);
                break;
            case R.id.shebei_btn_tijiao:
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Content.SJSC, new Response.Listener<String>() {
                        ...
                        public void onResponse(String s) {
                            ...
                            if (ew.getStatus().equals("success")) {
                                Toast.makeText(SheBeiActivity.this, ew.getMessage() + "", Toast.LENGTH_SHORT).show();
                                et_MAC.setText("");
                                progressDialog.dismiss();
                            } else {
                                Toast.makeText(SheBeiActivity.this, ew.getMessage() + "", Toast.LENGTH_LONG).show();
...
//                            map.put("mac", "Sck-16-"+et_MAC.getText().toString()+"2707004b1200");
                            map.put("mac", et_MAC.getText().toString());
    ...
    private void volleyTest_a() {
        request = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(SheBeiActivity.this, android.R.layout.simple_spinner_item, province_arr);
                //设置样式
    ...
    private void volleyTest_b(int i) {
        ...
        if (province_ID.equals("1000011")) {
            city_arr = new String[]{"上海","千贯"};
            //添加内容
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(SheBeiActivity.this, android.R.layout.simple_spinner_item, city_arr);
            //设置样式
            arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            //添加适配器
    ...
    private void volleyTest_c(int i) {
        ...
        request_b = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter_Name = new ArrayAdapter<String>(SheBeiActivity.this, android.R.layout.simple_spinner_item, name_arr);
                //设置样式
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(SheBeiActivity.this, android.R.layout.simple_spinner_item, county_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
    ...
    private void volleyTest_d(int i) {
        ...
        request_c = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(SheBeiActivity.this, android.R.layout.simple_spinner_item, company_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
...
//                }
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(SheBeiActivity.this, android.R.layout.simple_spinner_item, floor_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
    ...
    private void volleyTest_f(int i) {
        ...
        Log.e("qianguan",i+"==");
        Log.e("qianguan",floor_ID);
        Log.e("qianguan",city_ID);
...
//                }
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(SheBeiActivity.this, android.R.layout.simple_spinner_item, room_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
    ...
    private void volleyTest_CH() {
        if (et_MAC.getText().toString().equals("")) {
            dialog("MAC不能为空?", false);
        } else {
            progressDialog.show();
            request_f = new StringRequest(Request.Method.POST, Content.dropDa, new Response.Listener<String>() {
                @Override
                public void onResponse(String s) {
                    City ew = new Gson().fromJson(s, City.class);
                    if (ew.getStatus().equals("success")) {
            ...
            request_f.setRetryPolicy(new DefaultRetryPolicy(20 * 1000, 1, 1.0f));
