...
public class PeiDianXiangActivity extends Activity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private void initView() {
        spinnerA = (Spinner) findViewById(R.id.peidianxiang_spinner1);
        spinnerB = (Spinner) findViewById(R.id.peidianxiang_spinner2);
        spinnerC = (Spinner) findViewById(R.id.peidianxiang_spinner3);
        spinnerD = (Spinner) findViewById(R.id.peidianxiang_spinner4);
        spinnerE = (Spinner) findViewById(R.id.peidianxiang_spinner5);
        spinnerF = (Spinner) findViewById(R.id.peidianxiang_spinner6);
        spinner_Name = (Spinner) findViewById(R.id.peidianxiang_spinner_Name);
        ...
        dingwei = (TextView) findViewById(R.id.peidianxiang_tv_dingwei);

        et_NAME = (EditText) findViewById(R.id.peidianxiang_et_NAME);
        et_MAC = (EditText) findViewById(R.id.peidianxiang_et_MAC);
        et_BZ = (EditText) findViewById(R.id.peidianxiang_et_BZ);

        back = (ImageView) findViewById(R.id.peidianxiang_img_back);
        scan = (Button) findViewById(R.id.peidianxiang_btn_scan);
        tijiao = (Button) findViewById(R.id.peidianxiang_btn_tijiao);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peidianxiang);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.peidianxiang_img_back:
                finish();
                break;
            case R.id.peidianxiang_btn_scan:
                Intent intent = new Intent();
                intent.setClass(PeiDianXiangActivity.this, MipcaActivityCapture.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivityForResult(intent, SCANNIN_GREQUEST_CODE);
                break;
            case R.id.peidianxiang_btn_tijiao:
                if (et_NAME.getText().toString().equals("") || et_MAC.getText().toString().equals("")) {
                    dialog("昵称或MAC不能为空?", false);
                } else {
                    progressDialog.show();
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Content.PDX, new Response.Listener<String>() {
...
//                            map.put("mac", "Sck-16-"+et_MAC.getText().toString()+"2707004b1200");
                            map.put("PDXID", et_MAC.getText().toString());
                            map.put("city", city_ID);
                            map.put("name", et_NAME.getText().toString());
                            map.put("floor", floor_ID);
                            map.put("longitude", lo);
                            map.put("latitude", la);
                            map.put("desc", et_BZ.getText().toString()); //备注
                            return map;
                        }
                    };
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int i, long id) {
        switch (parent.getId()) {
            case R.id.peidianxiang_spinner1:
                volleyTest_b(i);
                break;
            case R.id.peidianxiang_spinner2:
                volleyTest_c(i);
                break;
            case R.id.peidianxiang_spinner3:
                volleyTest_d(i);
                break;
            case R.id.peidianxiang_spinner4:
                volleyTest_e(i);
                break;
            case R.id.peidianxiang_spinner5:
                volleyTest_f(i);
                break;
            case R.id.peidianxiang_spinner6:
                //地图定位
                onCreate();
                initLocation();
                ...
                progressDialog.dismiss();
                break;
            case R.id.peidianxiang_spinner_Name:
    ...
    protected void dialog(final String str, final Boolean flag) {
        AlertDialog.Builder builder = new AlertDialog.Builder(PeiDianXiangActivity.this);
...
//                    volleyTest_CH();
    ...
    private void volleyTest_a() {
        request_a = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PeiDianXiangActivity.this, android.R.layout.simple_spinner_item, province_arr);
                //设置样式
    ...
    private void volleyTest_b(int i) {
        ...
        if (province_ID.equals("1000011")) {
            ...
            //添加内容
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PeiDianXiangActivity.this, android.R.layout.simple_spinner_item, city_arr);
            //设置样式
            arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            //添加适配器
    ...
    private void volleyTest_c(int i) {
        ...
        request_c = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter_Name = new ArrayAdapter<String>(PeiDianXiangActivity.this, android.R.layout.simple_spinner_item, name_arr);
                //设置样式
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PeiDianXiangActivity.this, android.R.layout.simple_spinner_item, county_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
    ...
    private void volleyTest_d(int i) {
        ...
        request_d = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PeiDianXiangActivity.this, android.R.layout.simple_spinner_item, company_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
    ...
    private void volleyTest_e(int i) {
        ...
        request_e = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PeiDianXiangActivity.this, android.R.layout.simple_spinner_item, floor_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
    ...
    private void volleyTest_f(int i) {
        ...
        request_f = new StringRequest(Request.Method.POST, Content.JGCX, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                //添加内容
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(PeiDianXiangActivity.this, android.R.layout.simple_spinner_item, room_arr);
                //设置样式
                arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                //添加适配器
